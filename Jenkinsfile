...
SonarQubeEnv ='Sonar-Scanner-2.8'
    ...
    stages {
        ...
        stage('Build & SonarScanner'){
		     steps{
                ...
                bat "\"${tool 'Sonar-Scanner-2.8'}\\SonarScanner.MSBuild.exe\" end /d:sonar.login=6c0d6aae91d338cfcf6efacb0e0542b8b8603624"
...
withSonarQubeEnv("$SonarQubeEnv") {
    bat "\"${tool 'Sonar-Scanner-2.8'}\\SonarScanner.MSBuild.exe\" begin /key:DevOps_1234 /name:Todo /v:1.0 /d:sonar.host.url=http://10.127.126.113:9000 /d:sonar.login=6c0d6aae91d338cfcf6efacb0e0542b8b8603624"
    }
}
